...
| | Greedy++ [15] | Peeling | O (𝑇 · 𝑚 log𝑛) | (1 + 𝜖) | Ω(Δ(𝐺)𝜌∗𝐺𝜖2) | Ω(Δ(𝐺)𝜌∗𝐺𝜖2) |
| | FWApp [25] | Convex Programming | O (𝑇 · 𝑚) | (1 + 𝜖) | Ω(𝑚𝑛Δ(𝐺)𝜖2) | Ω(𝑚𝑛Δ(𝐺)𝜖2) |
...
| | DFWApp [67] | Convex Programming | O (𝑇 · log1+𝜖 𝑛𝑚) | (1 + 𝜖) | Ω(𝑚·𝜅𝜖2) | Ω(𝑚·𝜅𝜖2) |
